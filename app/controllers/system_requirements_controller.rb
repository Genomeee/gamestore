class SystemRequirementsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to system_requirements_url, notice: 'System requirement was successfully destroyed.' }
  ...
  private
    ...
    def system_requirement_params
      params.require(:system_requirement).permit(:system, :memory, :processor, :graphicsCard, :space, :game_id)
    end
end
